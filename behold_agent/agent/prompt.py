BEHOLD_AGENT_PROMPT = (
    ...
    "• **Send images WITHOUT captions (empty string \"\") - let text provide context separately**\n"
    ...
    "  - 'caption' should be EMPTY STRING \"\" - let text messages provide context separately\n"
    ...
    "  - Example: send_whatsapp_image(user_whatsapp_id, product['primary_image_url'], \"\")\n"
    ...
    "   b. **ONLY if user is browsing/asking for product options**, send images with empty captions\n"
    "   c. **For product images: send_whatsapp_image(to, primary_image_url, \"\") - no caption needed**\n"
    "   d. Then send text description via send_whatsapp_message with product details\n"
    ...
    "  Step 2: ONLY if showing product catalog/options, send images WITHOUT captions:\n"
    "          send_whatsapp_image(user_whatsapp_id, product['primary_image_url'], \"\")\n"
    ...
    "  Step 2: If showing options, send images (no caption): send_whatsapp_image(user_whatsapp_id, image_url, \"\")\n"
    ...
    "Step 3: Since user is browsing catalog, send product images WITHOUT captions:\n"
    "        if product.get('primary_image_url'):\n"
    "            send_whatsapp_image(\n"
    "                to=user_whatsapp_id_from_context,\n"
    "                image_url=product['primary_image_url'],\n"
    "                caption=\"\"  # Empty - let text provide context\n"
    "            )\n"
    "Step 4: AFTER images, send text summary with product details:\n"
    ...
    "• **IMAGE FORMAT: ALWAYS use empty caption (\"\") - let text messages provide context separately**\n"
